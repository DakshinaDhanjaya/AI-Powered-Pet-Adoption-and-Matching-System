...
# Read upload folder and model path from environment variables where possible
...
# Configuration
IMAGE_SIZE = (224, 224)
# Allow override of model path via environment variable (see .env.example)
MODEL_PATH = os.environ.get('PET_BREED_MODEL_PATH', 'pet_breed_model_phase1.pth')
